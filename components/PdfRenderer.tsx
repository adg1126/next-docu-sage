...
import { cn, pdfRendererSchema } from '@/lib/utils';
...
export default function PdfRenderer({ fileUrl }: PdfRenderProps) {
  ...
  const formSchema = pdfRendererSchema(numPages!);
  ...
  const handlePageSubmit = ({ page }: z.infer<typeof formSchema>) => {
      ...
      <div className='h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2'>
        <div className='flex items-center gap-1.5'>
          <Button
            ...
            onClick={() => {
              setCurrentPage((prevVal) => (prevVal - 1 > 1 ? prevVal - 1 : 1));
          ...
          <Button
            ...
            onClick={() => {
              setCurrentPage((prevVal) =>
                prevVal + 1 > numPages! ? numPages! : prevVal + 1
              );
              setValue('page', String(currentPage + 1));
            }}
            variant='ghost'
        ...
        <div className='space-x-2'>
          ...
          <Button
            ...
            onClick={() => setRotation((prevVal) => prevVal + 90)}
          >
